...
# MAGIC val metricsLogger = new MetricsLogger(spark, jobId, runId, testCode, language, metricsTable)
# MAGIC
...
time_method_log_metrics(spark, job_id, run_id, test_code, language, metrics_table, TestsFactory().get_test_func(test_code))
